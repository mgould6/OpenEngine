...
bool detectRotationalWobbleBand(const glm::quat& q0, const glm::quat& q1, const glm::quat& q2, float maxSpanDeg)
{
    ...
    bool isConfined = angleSpan < maxSpanDeg;
    bool hasEnoughRotation = (angle01 + angle12) > 2.0f;
